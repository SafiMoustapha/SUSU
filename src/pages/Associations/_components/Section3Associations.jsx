...
const Section3Associations = () => {
    return (
        <section className="w-full bg-[#cfd8f555] flex flex-col-reverse md:flex-row items-start lg:items-center justify-center py-14 mt-20 lg:gap-60 gap-10 px-2 md:px-16 lg:h-[100vh]">
            <div className="h-full md:w-1/2 flex flex-col items-start justify-center">
            ...
            <div className="flex items-center justify-center h-[40vh] md:w-1/2">
