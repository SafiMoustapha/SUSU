...
const Section3Associations = () => {
    return (
        <section className="w-full bg-white flex flex-col md:flex-row items-start lg:items-center justify-center py-14 md:mt-20 lg:gap-60 gap-10 px-2 md:px-16 lg:h-[100vh]">
