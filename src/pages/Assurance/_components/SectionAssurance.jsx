    ...
    return (
        <section className="mt-20">
            <div className="px-10 py-20 bg-[#1acad72b]">
                <div className="text-center text-[#0d2063] mb-4 sm:mb-20">
                ...
                <div>
                    <ul className="grid sm:grid-cols-2 sm:px-10">
            ...
            <div className="my-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 lg:px-44 lg:pt-44 bg-white">
                    <div className="flex flex-col items-center justify-center p-2 sm:p-6">
                        <div className="rounded-3xl shadow-md relative">
                            <div className="flex justify-start items-center p-6 bg-[#a877dd35] sm:w-[500px] rounded-tl-3xl rounded-tr-3xl">
                    ...
                    <div className="flex flex-col items-center justify-center p-2 sm:p-6">
                        <div className="rounded-3xl shadow-md relative">
                            <div className="flex justify-start items-center p-6 bg-[#de2f7e34] sm:w-[500px] rounded-tl-3xl rounded-tr-3xl">
                    ...
                    <div className="flex flex-col items-center justify-center p-2 sm:p-6">
                        <div className="rounded-3xl shadow-md relative">
                            <div className="flex justify-start items-center p-6 bg-[#1acad72f] sm:w-[500px] rounded-tl-3xl rounded-tr-3xl">
