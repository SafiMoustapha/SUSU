...
const TranquilleAccueil = () => {
    return (
        <div className='text-white w-full' style={{ backgroundImage: `url(${fondWave})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className='flex items-center justify-start px-4 sm:px-20 pt-4 lg:px-40'>
                <h2 className='text-center md:text-start text-[#0D2063] font-semibold text-3xl'>
                    Soyez tranquille,
            ...
            <div className='flex items-center justify-start gap-2 px-20 lg:px-40 mb-6 text-[#0D2063]'>
                ...
                <img src={flecheDroite2} alt="" className='w-6 md:w-8' />
            </div>
            <div className='w-full flex items-center justify-center gap-4 sm:px-16'>
                <Carousel />
            </div>
