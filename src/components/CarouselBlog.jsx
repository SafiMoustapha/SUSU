...
//                     >
//                         <div className="flex items-center gap-6 bg-[#0d206330] rounded-2xl p-6">
//                             {/* Conteneur image - largeur réduite */}
...
//                             {/* Conteneur texte - prend le reste de l'espace */}
...
//                         className={`w-3 h-3 rounded-full ${currentSlide === index ? 'bg-[#0D2063]' : 'bg-gray-300'}`}
//                     />
//                 ))}
//             </div>
